...
#    curve(dnorm(x, mean(pdf_spi_6083), sd(pdf_spi_6083)), add=TRUE, col="darkblue", lwd=2)
    pyramid.plot(bks11, bks22, top.labels = c("1960-1983","SPI","1984-2007"), laxlab = c(50,25,0,25,50), raxlab = c(50,25,0,25,50), lxcol = spi.cols(11), rxcol = spi.cols(11), main = paste(nlat,nlon,sep = ""), labelcex = .5)
#    dev.off()
